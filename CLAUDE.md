...
**Backend tasks:**
- [ ] Monorepo setup (Turborepo, Expo, Fastify, Prisma, pnpm)
- [ ] Supabase project + full schema migration (ALL models including rewards/scanner groundwork)
...
**Mobile tasks:**
- [ ] Expo Router scaffold with tab navigator (4 tabs in S1–S6: Home, Plan, Shop, Saved — Rewards tab added in Sprint 7)
- [ ] Install offline dependencies: `@react-native-community/netinfo`, `@react-native-async-storage/async-storage`
- [ ] Install rate limiting: `@fastify/rate-limit` (configured in Sprint 1, limits added per-sprint)
- [ ] Auth screens: login, signup
- [ ] Onboarding flow: location permission → store selector → budget → dietary → complete
- [ ] Home screen: empty state with "Generate plan" button (button is non-functional until Sprint 2)
